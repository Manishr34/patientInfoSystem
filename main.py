...
class Database:
    def __init__(self):
        ...
        "CREATE TABLE IF NOT EXISTS patient_table (id PRIMARYKEY text, firstname text, lastname text, dateOfBirth "
        "text, monthOfBirth text, yearOfBirth text, gender text, address text, contactNumber text, emailAddress text, "
        "bloodType text, history text, doctor text)")
...
class InsertWindow:
    ...
    def Insert(self):
        ...
        self.contactNumberEntry.get(), self.emailAddressEntry.get(), self.historyEntry.get(),
